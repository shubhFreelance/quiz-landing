  ...
  return (
    <div className="home-container">
      ...
      >
        ...
        <motion.div className="info-block" whileHover={{ x: 5 }}>
      ...
      >
        <motion.div whileHover={{ scale: 1.05 }} className="powered-by">
          Powered By Goa Winner
        </motion.div>
        <motion.p whileHover={{ color: "#f59e0b" }} className="copyright">
          ⓒ2025 Goa Winner
        </motion.p>
      </motion.footer>
    </div>
